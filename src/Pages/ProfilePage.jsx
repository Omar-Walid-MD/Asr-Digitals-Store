...
function ProfilePage({}) {
    ...
    return (
        <div className='page-container bg-light py-3 px-0 p-md-3'>
            <Container className='px-2'> <h2 className='mt-5 mb-2'>Profile</h2> </Container>
                                ...
                                <div>
                                    <div className="d-flex justify-content-between mb-2">
                                        ...
                                        <div className='d-flex gap-2 align-items-center text-primary gap-1'>
                                        {
                                            edit ?
                                            <>
                                                <Button variant='danger' className='d-flex align-items-center gap-2 p-1 px-2 border-3' onClick={()=>{discardEdit()}}><BsFillEraserFill /> Discard </Button>
                                                <Button variant='success' type='submit' form={`profile-form-${navSelect}`} className='d-flex align-items-center gap-2 p-1 px-2 border-3'><FaSave /> Save Changes </Button>
                                            </>
                                            :
                                            <Button variant='primary' className='d-flex align-items-center gap-2 p-1 px-2 border-3' onClick={()=>{setEdit(!edit)}}><BsFillPencilFill /> Edit </Button>
                                        }
                                        </div>
                                    </div>
                                        ...
                                        <Carousel.Item>
                                            <form id='profile-form-1' onSubmit={handleSubmitBasic(onSubmit)} className="d-flex bg-light flex-column gap-3 p-1">
                                                ...
                                                <div className="d-flex justify-content-end align-items-end" style={{height:"150px"}}>
                                                    <Button variant='danger' onClick={()=>{handleDeleteModalShow();}}>Delete Account</Button>
                                                </div>
                                            </form>
                                        </Carousel.Item>
            ...
            <Modal show={deleteModal} onHide={handleDeleteModalClose} centered={true} className='bg-transparent'>
                ...
                <Modal.Body>
                    <form className="d-flex flex-column align-items-center gap-3" onSubmit={handleSubmitConfirmDelete(onSubmitConfirmDelete)}>
                        ...
                        <Button className='w-100' variant='danger' type='submit'>Delete Account</Button>
                    </form>
                </Modal.Body>
            </Modal>
