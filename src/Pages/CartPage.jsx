        ...
        <div className='bg-secondary-subtle p-3'>
            <Container>
                ...
                <div className="d-flex justify-content-end w-100">
                    <div className='p-4 w-xs-100 w-sm-50 d-flex flex-column flex-md-row align-items-center justify-content-between gap-3 bg-secondary rounded-3 rounded-top-0 mt-2 shadow'>
